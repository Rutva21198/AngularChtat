...
export class FacebookUserAddComponent extends AbstractFacebookUser implements OnInit, OnDestroy {
    ...
    submit(){
        ...
        this.post({ body: { firstName: this.facebookUserFormGroup.controls.firstName.value,
             lastName:this.facebookUserFormGroup.controls.lastName.value, 
            mobileNo:this.facebookUserFormGroup.controls.mobileNo.value,
            email:this.facebookUserFormGroup.controls.email.value,
            password:this.facebookUserFormGroup.controls.password.value,
            dateOfBirth:this.facebookUserFormGroup.controls.dateOfBirth.value,
            genderAO:this.facebookUserFormGroup.controls.genderAO.value }
         }).subscribe(res => {
